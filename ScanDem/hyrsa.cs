    ...
    public class hyrsa
    {
        ...
        public class RSAUtil
        {
            ...
            public static bool Verify(String OriginalString, String SignatureString, String publicKeyPath)
            {
                ...
                str = RSAPublicKeyJava2DotNet(GetPemstr("PUBLIC KEY", str));
            ...
            private static string GetPemstr(string type, string data)
            {               
                string header = String.Format("-----BEGIN {0}-----", type);
                string footer = String.Format("-----END {0}-----", type);
                int start = data.IndexOf(header) + header.Length;
                int end = data.IndexOf(footer, start);
                string base64 = data.Substring(start, (end - start));
                return base64;
            }
